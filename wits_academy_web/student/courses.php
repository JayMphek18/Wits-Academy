...
<head>
    ...
    <?php 
        ...
        $sql="select * from enrollment where student_num='$user'";
    ...
    <?php }else{
        while($enroll=$result->fetch_assoc()){
                $course=getCourse($enroll['course_id'], $conn);
            ?>
            ...
            <div class="div-block-12">
                ...
                <a href="unenroll.php?id=<?php echo $course['course_id']?>" class="text-block-20"><i class="fas fa-trash"></i> Un-enroll</a>
            </div>
        </li>
    <?php
        }
