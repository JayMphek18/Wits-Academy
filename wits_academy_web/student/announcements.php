    ...
    <section class="section3">
        ...
        <?php 
            if(mysqli_num_rows($result1) == 0){ ?>
                <li class="list-item-5"><div> No accouncements available </div></li>
            <?php }else{
                while($announce=$result1->fetch_assoc())
                {
            ?>
                <li class="list-item-5"><a href="viewAnnounce.php?id=<?php echo $id ?>&announce=<?php echo $announce['announce_id'] ?>" class="link-14"><i class="fas fa-bullhorn"></i> <?php echo $announce['topic'] ?></a>
