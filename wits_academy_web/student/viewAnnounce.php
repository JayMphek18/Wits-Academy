...
<section class="section-9">
    ...
    ?>
        ...
        <div>Sent at <?php echo $row['date_time'] ?></div>
        <p class="paragraph-2"><?php echo $row['announce_text'] ?></p>
        <a href="announcements.php?id=<?php echo $id ?>" class="btn btn-primary">Back</a>
    </section>
