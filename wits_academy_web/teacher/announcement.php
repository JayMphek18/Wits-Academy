...
<body class="body">
        ...
        <div class="form-block">
            <form class="form" method="post" action="../php/send_announcement.php?id=<?php echo $id ?>" enctype="multipart/form-data">
            <div><h2 class="head2"><center>Please fill in all details below:</center></h2></div>
                ...
                <input class="input" name="subject" placeholder="Enter the topic/ subject" />
                <label for="Announcement">Announcement:</label>
                <textarea class="input" name="announcement" rows="4" cols="50" placeholder="Enter your announcement" required></textarea>
