...
<body class="body">
    ...
    <section class="section3">
        ...
        <ul role="list" class="list-5">
            <li class="list-item-5"><a href="announcement.php?id=<?php echo $id ?>" class="btn btn-success"><i class="fas fa-add"></i> Send a new announcement</a></li>
            <?php 
            while($announce=$result1->fetch_assoc())
            {
            ?>
            <li class="list-item-5"><div href="#" class="link-14"><i class="fas fa-bullhorn"></i> <?php echo $announce['topic'] ?></div>
            <div class="text-block-12">Created at <?php echo $announce['date_time'] ?></div>
            <a href="editAnnounce.php?id=<?php echo $id ?>&announce=<?php echo $announce['announce_id'] ?>" class="btn btn-info"><i class="fas fa-pencil"></i> Edit Announcement</a>
            <a href="deleteAnnounce.php?id=<?php echo $id ?>&announce=<?php echo $announce['announce_id'] ?>" class="btn btn-danger"><i class="fas fa-trash"></i> Delete Announcement </a>
            </li>
            <?php } ?>
        </ul>
            </section>
