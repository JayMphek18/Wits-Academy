...
<head>
    ...
    <div class="form-block">
            <form class="form" action="../php/deleteCourse.php?id=<?php echo $id ?>" method="post">
                <label for="answer">Are you sure you want to delete this course?</label>
                ...
                <div class="text-block1"> All contents of this course will be deleted.</div><br>
                <input type="submit"  class="delete" name="delete" value="Submit" />
            </form>
            <br>
            <center><a href="manage_courses.php" class="btn btn-primary"> Back </a></center>
        </div>
    </body>
</html>
<?php }
