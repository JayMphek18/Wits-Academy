...
<body class="body">
    <div class="container">
        <?php
            ...
            <form class="form" action="../php/create_ques.php?id=<?php echo $id ?>&quiz_name=<?php echo $name ?>&q=<?php echo $q ?>&num=<?php echo $num ?>" method="post">
                ...
                <input type="number"  name="mark" maxlength="255" placeholder="Enter question mark" class="input" required="">
