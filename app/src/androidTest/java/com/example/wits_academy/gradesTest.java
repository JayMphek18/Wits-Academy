...
public class gradesTest {
    @Rule
    public ActivityTestRule<grades> mActivityRule = new ActivityTestRule(grades.class);
    private grades teacher_quiz;
...
//
    ...
    @Test
    public void addteacher_quiz() throws Throwable {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                ViewsClass.grades(teacher_quiz.getApplicationContext(), course_list, "1234567", "Zenzele", "50");
                ViewsClass.grades(teacher_quiz.getApplicationContext(), course_list, "1234567", "Zenzele",  "50");
                ViewsClass.grades(teacher_quiz.getApplicationContext(), course_list, "1234567", "Zenzele",  "50");
            }
        });
        assertEquals(course_list.getChildCount(), 4);
    }
