...
//        final NavigationViewActivity activity = mActivityRule.getActivity();
    ...
    public void spinnerDisplay(){
        ...
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("1 - First Year"))));
        assertEquals(create.year.toString(), "1");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(1).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("2 - Second Year"))));
        assertEquals(create.year.toString(), "2");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(2).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("3 - Third Year"))));
        assertEquals(create.year.toString(), "3");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(3).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("4 - Forth Year"))));
        assertEquals(create.year.toString(), "4");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(4).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("5 - Fifth Year"))));
        assertEquals(create.year.toString(), "5");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(5).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("6 - Sixth Year"))));
        assertEquals(create.year.toString(), "6");
        closeSoftKeyboard();
        onView(withId(R.id.year_of_study)).perform(click());
        onData(anything()).atPosition(6).perform(click());
        onView(withId(R.id.year_of_study)).check(matches(withSpinnerText(containsString("7 - Seventh Year"))));
